...
#define	AD7124_RDY_EXTI_IRQn	EXTI2_IRQn
/*
*********************************************************************************************************
...
//	GPIOC->ODR ^= (GPIO_PIN_13);
	_RDY = 0;
	HAL_NVIC_DisableIRQ(AD7124_RDY_EXTI_IRQn); 
}
...
//  GPIO_Init(GPIOA, &GPIO_InitStructure);//初始化
	...
	HAL_NVIC_SetPriority(AD7124_RDY_EXTI_IRQn,1,1);   
	HAL_NVIC_DisableIRQ(AD7124_RDY_EXTI_IRQn);   		
...
//	volatile u8 readdata,rx_data1,i;
	...
	switch(u8FSM_RdSingle)
	{
		...
		case 1:
				...
				HAL_NVIC_EnableIRQ(AD7124_RDY_EXTI_IRQn); 
